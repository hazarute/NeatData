...
## Modülerlik Hedefi
Proje, tüm temizlik adımlarının ayrı modüller/fonksiyonlar olarak organize edildiği, genişletilebilir ve özelleştirilebilir bir mimariye sahip olmalıdır. Pipeline yönetimi merkezi bir yapı (pipeline_manager.py) üzerinden yapılır ve config dosyasından dinamik olarak yüklenir. Kullanıcı ve geliştirici pipeline’ı config dosyası veya arayüz ile kolayca değiştirebilir. Yeni modüller eklenebilir, adımların sırası ve parametreleri dinamik olarak yönetilebilir.
## Kapsam
...
- Eksik/hatalı değerleri (ERROR, UNKNOWN, boşluk, NaN, N/A, null, -, ?) standart şekilde yönetir.
...
- openpyxl
## Nihai Hedef
Kullanıcıların farklı kaynaklardan gelen bozuk/dağınık CSV dosyalarını otomatik ve esnek şekilde temizleyip, analiz için hazır ve tutarlı veri setleri elde etmelerini sağlamak. Proje büyüdükçe pipeline yönetimi, hata yönetimi, loglama ve modül ekleme/çıkarma merkezi olarak yönetilecek.
# Proje Özeti (projectbrief.md)
